 ...
 *
 */
public class JCB extends Login {

	public void getJCB() throws InterruptedException {
		...
		click1 = driver.findElement(By.xpath(SharedIdentifiers.XPATH_CARD_TYPE_JCB));
		click1.click();
		...
		try {
			...
			System.out.println("JCB = " + total);
		} catch (Exception exp) {
			System.out.println("JCB = 0.00 ");
		}
